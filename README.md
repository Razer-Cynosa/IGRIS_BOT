![ZORO](https://telegra.ph/file/d1b27baeaaeca127ceae5.jpg) 
# ZORO_BOT
...
Originally a Marie fork, ZORO evolved further and was built to be more robust and more dedicated to Anime Chats. 
...
### Read these notes carefully before proceeding 
 ...
 - Your code must be open source and a link to your fork's repository must be there in the start reply of the bot. [See this](https://github.com/Razer-Cynosa/IGRIS_BOT/blob/shiken/SaitamaRobot/__main__.py#L25)
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Razer-Cynosa/ZORO_BOT) 
...
For queries or any issues regarding the bot please open an issue ticket or visit us at [ZORO BOT SUPPORT](https://t.me/caritemanataudoi)
## How to setup on Heroku 
For starters click on this button 

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Razer-Cynosa/ZOROXBOT.git) 
...
Should any be missing kindly let us know at [ZORO BOT SUPPORT](https://t.me/caritemanataudoi) or simply submit a pull request on the readme.
